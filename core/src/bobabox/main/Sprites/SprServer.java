...
public class SprServer extends Sprite {
    ...
    public SprServer(float _fX, float _fY) {
        ...
        TextureRegion[][] trTmpFrames = TextureRegion.split(txtSheet, txtSheet.getWidth()/5, txtSheet.getHeight()/4);
...
//        System.out.println(fX + " SERVER X");
     //   System.out.println(fY + " SERVER Y");
